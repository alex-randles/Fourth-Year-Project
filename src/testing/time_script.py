...
def timeScript(scriptName):
      ...
      if scriptExtension == "sh":
	    os.system("$HOME/projectSourceCode/commandScripts/" + scriptName) 
      else:
	    os.system("python $HOME/projectSourceCode/commandScripts/" + scriptName) 
...
def recordTime(timeTaken,scriptName):
      ...
      f = open(fileName,"a") 
      f.write("Script: $HOME/projectSourceCode/commandScripts/{} took {} seconds to execute\n".format(scriptName,timeTaken)) 
