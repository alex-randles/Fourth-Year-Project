###############################################################################################
#### Added by Alex Randles
#### This code was written by snowboy and is openly available, I take no credit for this code
###############################################################################################
...
class HotwordDetector(object):
    ...
    def record_proc(self):
        CHUNK = 1024
        RECORD_RATE = 16000
        #cmd = 'arecord -q -r %d -D -f S16_LE' % RECORD_RATE
        os.system("killall arecord")
        cmd = 'arecord -q -r %d -D plughw:2,0 -f S16_LE' % RECORD_RATE
        # "arecord recording.wav -f S16_LE -r 16000 -D plughw:2,0 -d 5
