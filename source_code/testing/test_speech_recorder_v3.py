...
os.system("sox -t alsa default ./record.wav silence 1 0.5 2% 1 1.0 2%") # first 3 are input when to start recording when sound is 5% and stop recording when sound less then 5% and 1 second gap   
